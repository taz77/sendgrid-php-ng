...
/**
 * This class is used to construct a Ganalytics object for the /mail/send API
 * call
 *
...
class Ganalytics implements JsonSerializable {
   ...
   *                                  Google, SomeDomain.com, or Marketing
   *   Email)
  ...
  /**
   * Return an array representing a Ganalytics object for the Twilio SendGrid
   * API
   *
   * @return null|array
   */
