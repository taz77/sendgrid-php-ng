...
/**
 * This class is used to construct a SpamCheck object for the /mail/send API
 * call
 *
...
class SpamCheck implements JsonSerializable {
  ...
  /**
   * @var $threshold int The threshold used to determine if your content
   *   qualifies as spam on a scale from 1 to 10, with 10 being most strict, or
   *   most likely to be considered as spam
   */
  private $threshold;

  /**
   * @var $post_to_urlstring An Inbound Parse URL that you would like a copy of
