...
class Mail implements JsonSerializable {
   ...
   * @param Substitution[]|array|null $globalSubstitutions Substitutions for
   *   entire email
   *
  ...
  /**
   * Retrieve the number of Personalization objects associated with the Mail
   * object
   *
   * @return int
   */
   ...
   *                                    a copy of your email along with the
   *   spam
