...
class TrackingSettings implements JsonSerializable {
   ...
   *                                        included in the text/plain portion
   *   of your email
   *
   * @throws SendgridException
   */
   ...
   *                                                    example:
   *                                                    [unsubscribe_url]. If
   *   this parameter is used, it will override both the text and html
   *   parameters. The URL of the link will be placed at the substitution tag’s
  ...
  /**
   * Return an array representing a TrackingSettings object for the Twilio
   * SendGrid API
   *
   * @return null|array
   */
