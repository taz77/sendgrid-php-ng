...
class SendAt implements JsonSerializable {
  ...
  /**
   * @var $send_at int A unix timestamp allowing you to specify when you want
   *   your email to be delivered. This may be overridden by the
   *   personalizations[x].send_at parameter. You can't schedule more than 72
   *   hours in advance. If you have the flexibility, it's better to schedule
   *   mail for off-peak times. Most emails are scheduled and sent at the top
   *   of the hour or half hour. Scheduling email to avoid those times (for
   *   example, scheduling at 10:53) can result in lower deferral rates because
   *   it won't be going through our servers at the same times as everyone
   *   else's mail
   */
  private $send_at;
   ...
   *                          in advance. If you have the flexibility, it's
   *   better to schedule mail for off-peak times. Most emails are scheduled
   *   and sent at the top of the hour or half hour. Scheduling email to avoid
   *   those times (for example, scheduling at 10:53) can result in lower
   *   deferral rates because it won't be going through our servers at the same
   *   times as everyone else's mail
   *
