...
/**
 * This class is used to construct a CustomArg object for the /mail/send API
 * call
 *
 * Values that are specific to the entire send that will be carried along with
 * the email and its activity data. Substitutions will not be made on custom
 * arguments, so any string that is entered into this parameter will be assumed
 * to be the custom argument that you would like to be used. This parameter is
 * overridden by personalizations[x].custom_args if that parameter has been
