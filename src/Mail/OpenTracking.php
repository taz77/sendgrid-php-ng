...
/**
 * This class is used to construct a OpenTracking object for the /mail/send API
 * call
 *
 * Allows you to track whether the email was opened or not, but including a
 * single pixel image in the body of the content. When the pixel is loaded, we
 * can log that the email was opened
 *
...
class OpenTracking implements JsonSerializable {
  ...
  /**
   * Return an array representing a OpenTracking object for the Twilio SendGrid
   * API
   *
   * @return null|array
   */
